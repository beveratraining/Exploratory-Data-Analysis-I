...
plot(x, y1, type = "b", frame = FALSE, pch = 19, 
     col = "red", xlab = "x", ylab = "y", ylim = c(0,200)) #changing the y-axis limits, 0-200
...
barplot(x)
# Horizontal bar plot
barplot(x, horiz = TRUE, cex.names = .9)
x
```
...
barplot(x, ylab = "Rate", cex.axis = .9)
...
hist(Temperature, breaks=  , main="With breaks=5")
